...
Overview:
    This model simulates weekly soil moisture dynamics, accounting for precipitation, temperature, biomass, soil properties (clay content), and site elevation.
    It provides estimates of soil water balance components and plant water stress for ecohydrological and agricultural applications.

Parameters (SoilWaterParams):
...
Outputs (per week, DataFrame columns):
...
Units:
    - All water fluxes and storages: millimeters (mm)
    - Biomass: grams of carbon per square meter (gC/m²)
